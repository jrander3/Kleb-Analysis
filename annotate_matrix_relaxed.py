...
# === FILE LOCATIONS ===
matrix_file = "arg_matrix_relaxed/arg_presence_absence.csv"
...
df.to_csv("arg_matrix_relaxed/arg_matrix_annotated.csv")
print("✅ Annotated matrix saved to arg_matrix_relaxed/arg_matrix_annotated.csv")
